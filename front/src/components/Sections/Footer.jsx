    ...
    <footer className="max-w-7xl m-auto w-full p-8">
      ...
      <div className="flex flex-col md:flex-row justify-between">
        <div className="max-w-5xl m-0 md:m-auto grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-8 ">
          <a
            href="https://exnihilo.fr/"
            className="flex items-center justify-center mb-9 md:mb-0 col-span-2 sm:col-span-3 md:col-span-1"
          >
            <img
              src="/static/svg/Logo_complet.svg"
              className="h-52 mx-5"
              alt="Exnihilo Logo"
            />
          </a>
              ...
              {navbarItems.map((elem) => {
                return (
                  <li
                    ...
                    className="pb-4 hover:underline cursor-pointer"
                  >
                    {elem.name}
                  </li>
                );
          ...
          <article className="text-right sm:text-left">
            ...
            <ul className="text-ex_dark_purple dark:text-ex_light_purple">
              <li className="pb-4">
                <a
                  href="https://www.linkedin.com/company/exnihilo-smartworkwear/"
                  target="_blank"
              ...
              <li>
                <a
                  href="https://instagram.com/exnihilo_smartworkwear?igshid=YmMyMTA2M2Y="
                  target="_blank"
                  className="hover:underline cursor-pointer"
                >
                  Instagram
          ...
          <article className="col-span-2 sm:col-span-1 text-center sm:text-left">
            <h2 className="pb-6 text-sm font-extrabold text-ex_normal_purple  uppercase dark:text-ex_normal_purple">
              Contactez-nous
            </h2>
            <ul className="text-ex_dark_purple dark:text-ex_light_purple">
              <li className="pb-4">
                <a href="tel:+33(0) 556 409 686" className="hover:underline">
                  +33(0) 556 409 686
                </a>
              </li>
              <li className="mb-4">
                <a
                  href="mailto:contact@exnihilo.fr"
      ...
      <div className="flex flex-col sm:flex-row items-center sm:justify-between ">
        <span className="flex text-sm text-ex_dark_purple dark:text-ex_light_purple">
          © 2023
          <a
            href="https://epure.digital/"
            target="_blank"
            className="hover:underline"
          >
            Épure™
        ...
        <div className="flex mt-4 space-x-6 justify-center sm:mt-0">
          ...
          >
            <svg
              className="w-5 h-5 fill-ex_dark_purple dark:fill-ex_light_purple"
              viewBox="0 0 24 24"
              aria-hidden="true"
            >
