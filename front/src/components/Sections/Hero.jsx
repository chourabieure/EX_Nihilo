...
const Hero = () => {
  return (
    <section
      id="1"
      className={`h-[calc(100vh_-_84px)] flex flex-col relative justify-between items-center py-8  text-ex_dark_purple`}
    >
      {/* Spacer */}
      <div />
      ...
      <motion.section
        ...
        className="px-8 z-10"
      >
        <div className="text-4xl transition-all sm:text-5xl md:text-6xl lg:text-6xl text-center text-ex_dark_purple dark:text-ex_light_purple font-medium  pb-8">
