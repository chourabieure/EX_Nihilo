        ...
        >
            <div className="relative text-ex_light_purple text-center sm:text-left ">
                ...
                {center ? (
                    ...
                    <h3
                        dangerouslySetInnerHTML={{ __html: title }}
                        className="font-Miju text-5xl absolute bottom-0 left-1/2  sm:-left-8 -translate-x-1/2 sm:translate-x-0 whitespace-nowrap opacity-10"
                    ></h3>
                )}
            </div>
        </motion.div>
