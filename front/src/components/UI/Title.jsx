      ...
      {center ? (
        <div className="relative text-ex_dark_purple dark:text-ex_light_purple">
          <h2
            ...
            className="font-Miju text-center text-4xl leading-8 whitespace-nowrap"
          ></h2>
          <h3
            dangerouslySetInnerHTML={{ __html: title }}
            className="font-Miju text-center text-5xl absolute bottom-0 left-1/2 -translate-x-1/2 whitespace-nowrap opacity-10"
          ></h3>
        </div>
      ) : (
