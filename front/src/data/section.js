...
const que_faisons_nous = {
    ...
    video: "Défilé.mp4",
    subtitle:
        "Adeptes du Design thinking, c’est avec vos équipes que nous travaillons le mieux.",
    description:
        "Riche de 23 années d’expérience, nous avons développé un savoir-faire et une expertise unique. Nous vous aidons à anticiper les évolutions réglementaires et les nécessités environnementales. Notre démarche d’éco conception vise à l’amélioration de la durabilité des produits et une optimisation de leur recyclage. Nous vous accompagnons sur la globalité de votre projet d’habillement professionnel par des prestations ciblées et complémentaires de Conseil, de Design et d’Expertise.",
};

export { qui_sommes_nous, que_faisons_nous };
